...
impl Engine {
    ...
    pub(crate) async fn execute(
        ...
        Vec<heph_sandboxfuse::SlotGuard>,
    )> {
        let driver = self
            .drivers_by_name
            .get(&spec.driver)
        ...
        heph_core::hmemoizer::set_phase("execute:inputs_result_exec");
        ...
        heph_core::hmemoizer::set_phase("execute:semaphore_acquire");
        ...
        let res = crate::engine::event::emit_scope(
            ...
            async {
                ...
                heph_core::hmemoizer::set_phase("execute:sandbox_remove");
                ...
                heph_core::hmemoizer::set_phase("execute:driver_run");
                exec_wrapper(inner).await.with_context(|| "run")?;

                heph_core::hmemoizer::set_phase("execute:oneshot_rx");
                let res = rx
                    .await
        ...
        .await;
        heph_telemetry::telemetry::record_execute_ms(exec_started.elapsed().as_millis() as u64);
        res
    }
...
{
    heph_proc::process_supervisor::block_or_inline(f)
}
