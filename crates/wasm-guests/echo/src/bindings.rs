...
pub fn host_lookup(key: &str) -> _rt::String {
    unsafe {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:echo:echo:encoded world"
)]
#[doc(hidden)]
...
@\x01\x03keys\0s\x03\0\x0bhost-lookup\x01\0\x01@\x01\x04names\0s\x04\0\x05greet\x01\
\x01\x04\0\x13component:echo/echo\x04\0\x0b\x0a\x01\0\x04echo\x03\0\0\0G\x09prod\
