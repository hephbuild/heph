...
func analyzeTestMain(importPath string, files []string) (*Analysis, error) {
	analysis := Analysis{
...
// Code generated by Heph for test binary. DO NOT EDIT.
package main
import (
	"os"
{{- if .TestMain}}
...
func generateTestMain(analysis *Analysis) ([]byte, error) {
